...
def to_slug(name)
  ...
  clusters_data_centro_oeste = [
    ...
    { name: "Padre Bernardo", milestone: -1, conjunto: "DF1", active: true },
    { name: "Planaltina", alias: "Planaltina de Goiás", milestone: -1, conjunto: "DF1", active: true },
    ...
    { name: "Vale do Rio dos Bois", milestone: -1, conjunto: "GO1", active: true },

    { name: "Anicuns", milestone: -1, conjunto: "GO2", active: true },
    { name: "Ceres", milestone: -1, conjunto: "GO2", active: true },
    { name: "Inhumas", milestone: -1, conjunto: "GO2", active: true },
    { name: "Itaberaí", milestone: -1, conjunto: "GO2", active: true },
    { name: "Jaraguá", milestone: -1, conjunto: "GO2", active: true },
    { name: "Núr", milestone: 2, conjunto: "GO2", active: true },

    { name: "Caldas Novas", milestone: -1, conjunto: "GO3", active: true },
    { name: "Itumbiara", milestone: -1, conjunto: "GO3", active: true },
    { name: "Morrinhos", milestone: -1, conjunto: "GO3", active: true },
    { name: "Piracanjuba", milestone: -1, conjunto: "GO3", active: true },

    { name: "Chapada dos Veadeiros", milestone: -1, conjunto: "GO4", active: false },
    { name: "Goianésia", milestone: -1, conjunto: "GO4", active: false },
    { name: "Porangatu", milestone: -1, conjunto: "GO4", active: false },
    { name: "Uruaçu", milestone: -1, conjunto: "GO4", active: false },
    { name: "Vão do Paraná", milestone: -1, conjunto: "GO4", active: false },

    { name: "Aragarças", milestone: -1, conjunto: "GO5", active: false },
    { name: "Barra do Garças", milestone: -1, conjunto: "GO5", active: false },
    { name: "Iporá", milestone: -1, conjunto: "GO5", active: false },
    { name: "Rio Vermelho", id_objeto: 55680, milestone: -1, conjunto: "GO5", active: false },
    { name: "São Miguel do Araguaia", milestone: -1, conjunto: "GO5", active: false },

    { name: "Jataí", milestone: -1, conjunto: "GO6", active: false },
    { name: "Mineiros", milestone: -1, conjunto: "GO6", active: false },
    { name: "Quirinópolis", milestone: -1, conjunto: "GO6", active: false },
    { name: "Rio Verde", milestone: -1, conjunto: "GO6", active: false },

    { name: "Esplendor da Glória", milestone: 3, conjunto: "TM1", active: true },
    { name: "Ituiutaba", milestone: -1, conjunto: "TM1", active: true },
    { name: "Catalão", milestone: 2, conjunto: "TM1", active: true },
    { name: "Ipameri", milestone: -1, conjunto: "TM1", active: true },
    { name: "Pires do Rio", milestone: -1, conjunto: "TM1", active: true },

    { name: "Araxá", milestone: -1, conjunto: "TM2", active: true },
    { name: "Frutal", milestone: -1, conjunto: "TM2", active: true },
    { name: "Patos de Minas", milestone: -1, conjunto: "TM2", active: true },
    { name: "Patrocínio", milestone: -1, conjunto: "TM2", active: true },
    { name: "Uberaba", milestone: 1, conjunto: "TM2", active: true },

    { name: "Araguacema", milestone: -1, conjunto: "TO1", active: true },
    { name: "Girassois", milestone: 3, conjunto: "TO1", active: true },
    { name: "Guaraí", milestone: -1, conjunto: "TO1", active: true },
    { name: "Miracema do Tocantins", milestone: -1, conjunto: "TO1", active: true },
    { name: "Paraíso do Tocantins", milestone: -1, conjunto: "TO1", active: true },
    { name: "Porto Nacional", milestone: 0, conjunto: "TO1", active: true },

    { name: "Formoso do Araguaia", milestone: -1, conjunto: "TO2", active: false },
    { name: "Gurupi", milestone: 2, conjunto: "TO2", active: true },
    { name: "Peixe", milestone: -1, conjunto: "TO2", active: false },

    { name: "Arraias", milestone: -1, conjunto: "TO3", active: false },
    { name: "Chapada da Natividade", milestone: -1, conjunto: "TO3", active: false },
    { name: "Dianópolis", milestone: -1, conjunto: "TO3", active: false },
    { name: "Jalapão", milestone: -1, conjunto: "TO3", active: true },

    { name: "Araguaína", milestone: -1, conjunto: "TO4", active: true },
    { name: "Bico do Papagaio", alias: "Bico do Papaguaio", milestone: -1, conjunto: "TO4", active: false },
    { name: "Colinas do Tocantins", milestone: -1, conjunto: "TO4", active: false },
    { name: "Goiatins", milestone: -1, conjunto: "TO4", active: false },
    { name: "Tocantinópolis", milestone: -1, conjunto: "TO4", active: false },

    { name: "Ilha do Bananal - TO", milestone: -1, conjunto: "INDIGENAS", active: false },
    { name: "Parque Indígena do Xingu - MT", milestone: -1, conjunto: "INDIGENAS", active: false },

    { name: "Alto Guaporé", milestone: -1, conjunto: "MT1", active: true },
    ...
    { name: "Jauru", alias: "Jaurú", milestone: -1, conjunto: "MT1", active: true },

    { name: "Cáceres", milestone: 2, conjunto: "MT2", active: true },
    { name: "Rosário Oeste", milestone: -1, conjunto: "MT2", active: true },
    { name: "Tuiuiú", milestone: 2, conjunto: "MT2", active: true },

    { name: "Colider", alias: "Colider", milestone: -1, conjunto: "MT3", active: true },
    { name: "Nova Mutum", milestone: 1, conjunto: "MT3", active: true },
    { name: "Sinop", milestone: 3, conjunto: "MT3", active: true },
    { name: "Nobres", milestone: -1, conjunto: "MT3", active: true },

    { name: "Alto Araguaia", milestone: -1, conjunto: "MT4", active: false },
    { name: "Primavera do Leste", milestone: -1, conjunto: "MT4", active: false },
    { name: "Rondonópolis", milestone: -1, conjunto: "MT4", active: false },
    { name: "Tesouro", milestone: -1, conjunto: "MT4", active: false },

    { name: "Canarana", milestone: -1, conjunto: "MT5", active: false },
    { name: "Paranatinga", milestone: -1, conjunto: "MT5", active: false },
    { name: "São Félix do Araguaia", milestone: -1, conjunto: "MT5", active: false },
    { name: "Vila Rica", milestone: -1, conjunto: "MT5", active: false },

    { name: "Alta Floresta", milestone: -1, conjunto: "MT6", active: false },
    { name: "Arinos-Juara", milestone: -1, conjunto: "MT6", active: false },
    { name: "Aripuanã", milestone: -1, conjunto: "MT6", active: false },
    { name: "Juína", milestone: -1, conjunto: "MT6", active: false },

    { name: "Canto do Rouxinol", milestone: 3, conjunto: "MS1", active: true },
    { name: "Corguinho", milestone: 0, conjunto: "MS1", active: true },
    { name: "Paranaíba", milestone: -1, conjunto: "MS1", active: true },
    { name: "Três Lagoas", milestone: -1, conjunto: "MS1", active: true },

    { name: "Amambai", milestone: 1, conjunto: "MS2", active: true },
    { name: "Glória de Dourados", milestone: -1, conjunto: "MS2", active: true },
    { name: "Rio Brilhante", milestone: 2, conjunto: "MS2", active: true },
    { name: "Terra Dourada", milestone: 3, conjunto: "MS2", active: true },

    { name: "Naviraí", milestone: 3, conjunto: "MS3", active: false },
    { name: "Nova Andradina", milestone: -1, conjunto: "MS3", active: false },
    { name: "Ponta Porã", milestone: 1, conjunto: "MS3", active: true },
    { name: "Sete Quedas", milestone: -1, conjunto: "MS3", active: false },

    { name: "Aquidauana", milestone: 1, conjunto: "MS4", active: true },
    { name: "Bonito", milestone: -1, conjunto: "MS4", active: false },
    { name: "Corumbá", milestone: -1, conjunto: "MS4", active: false },
    { name: "Jardim", milestone: 1, conjunto: "MS4", active: false },

    { name: "Cassilândia", milestone: -1, conjunto: "MS5", active: false },
    { name: "Coxim", milestone: -1, conjunto: "MS5", active: false },
